    ...
    return (
        <section className='relative w-full min-h-screen p-10 flex justify-center items-center' id="intro">
            ...
            <div className='text-5xl z-40 text-center text-white my-20'>
                ...
                <a href="#about" className='rounded-[4px] text-xs bg-white text-gray-800 py-2.5 px-7 mt-2.5 uppercase font-bold hover:bg-green-500 hover:text-white transition duration-200 ease-in-out'>EXPLORE</a>
            </div>
        </section>
    );
}
